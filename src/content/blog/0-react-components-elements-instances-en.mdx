...
| Operation | Vanilla JS | jQuery | React |
|----------|------------|--------|-------|
| Render 1,000 items | ~150ms | ~120ms | ~50ms |
| Update 100 items | ~80ms | ~60ms | ~15ms |
| Remove 500 items | ~70ms | ~55ms | ~10ms |
| Reorder list | ~100ms | ~90ms | ~5ms |

**Why is React faster?**
- Virtual DOM is pure JavaScript (no DOM access)
- Diff algorithm minimizes DOM operations
- Batching groups multiple updates
- Fiber architecture allows render interruption
