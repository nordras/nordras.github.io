...
React Hooks são funções especiais que permitem "ligar" o estado e outras funcionalidades do React a componentes funcionais.
Antes dos hooks, apenas componentes de classe podiam ter estado e ciclo de vida, mas com os hooks, componentes funcionais podem fazer tudo isso de forma mais simples e concisa.
